...
import { homeKPIs, checklistItems, recentActivities, currentUser } from "@/lib/mock-data";
    ...
    <>
      <div className="dash-page-header dash-animate-fade-up">
        <div className="dash-page-header-left">
          ...
          <h1 className="dash-page-title">Bonjour {currentUser.name.split(" ")[1] || currentUser.name}.</h1>
